...
const NeuralBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Tech keywords
    const KEYWORDS = [
      "Node.js", "Stream", "Async", "Await", "HTTP", 
      "JSON", "API", "404", "200", "POST", 
      "GET", "Error", "Deploy", "Build", "Run"
    ];
    ...
    const animate = () => {
      ...
      const dotColor = isDark ? 'rgba(255, 255, 255, 0.8)' : 'rgba(51, 65, 85, 0.8)'; 
      const wordColor = isDark ? 'rgba(74, 222, 128, 0.6)' : 'rgba(21, 128, 61, 0.6)'; // Brand Green for words
