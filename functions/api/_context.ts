...
export function buildSystemPrompt(locale?: string, selfModel?: string): string {
  ...
  return [
    ...
    '- The ONLY valid ids are: profile, about, stack, projects, career, education, articles, open-source, ai-usage, contact. Never invent other ids.',
    ...
    '  - [[action:scroll:<id>]] — scroll the visitor to a section. Valid ids: profile, about, stack, projects, career, education, articles, open-source, ai-usage, contact.',
